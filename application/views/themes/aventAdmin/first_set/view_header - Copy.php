...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url() ?>Manage/Homepage">
            ...
            ?>
                    <li class="nav-item">
                        <!-- <a class="nav-link collapsed" data-toggle="collapse" href="#" aria-expanded="false" aria-controls="collapseTwo">
                        ...
                        <!-- <div class="collapseTwo" id="<?php //echo "list" . $key; ?>"> -->
